...
HD_PWD='/home/user/Lab-6-Final-Project/Lab-6/Lab-6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab6_block_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab6_block_wrapper.tcl
