...
HD_PWD='/home/user/Lab-6-Final-Project/Lab-6/Lab-6.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab6_block_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab6_block_wrapper.tcl -notrace
